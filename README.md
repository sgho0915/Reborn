...
1인칭 기본 조작, 원룸 블록아웃, 사물 조사 및 운반·사용 검증 구현. 실행 방법은 [조작 테스트 안내](Documentation/first-person-test.md), [원룸 블록아웃 안내](Documentation/room-blockout.md), [사물 조사 안내](Documentation/interaction.md), [운반·사용 안내](Documentation/carry-and-use.md) 참고.
